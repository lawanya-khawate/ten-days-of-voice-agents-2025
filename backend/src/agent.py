...
def seed_database():
    ...
    try:
        ...
        if cur.fetchone()[0] == 0:
            catalog = [
                # Dairy
                ("milk-amul-1l", "Amul Milk", "Dairy", 72.00, "Amul", "1L", "pack", json.dumps(["dairy", "essential"])),
                ("paneer-200g", "Amul Paneer", "Dairy", 95.00, "Amul", "200g", "pack", json.dumps(["dairy", "protein", "veg"])),
                ...
                # Staples/Pantry
                ("atta-5kg", " Whole Wheat Atta", "Staples", 245.00, "Aashirvaad", "5kg", "bag", json.dumps(["flour", "roti"])),
                ("rice-basmati-1kg", "India Gate Basmati Rice", "Staples", 160.00, "India Gate", "1kg", "bag", json.dumps(["rice", "premium"])),
                ("dal-toor-1kg", "Tata Toor Dal", "Staples", 185.00, "Tata", "1kg", "pack", json.dumps(["protein", "dal"])),
                ("salt-1kg", "Salt", "Staples", 28.00, "Tata", "1kg", "pack", json.dumps(["essential"])),
                ("sugar-1kg", "Madhur Sugar", "Staples", 60.00, "Madhur", "1kg", "pack", json.dumps(["sweet"])),
                
                # Snacks & Instant
                ("maggi-masala", "Maggi Noodles", "Instant Food", 14.00, "Nestle", "70g", "pack", json.dumps(["snack", "noodles"])),
                ("biscuits-marie", " Marie Gold", "Snacks", 35.00, "Britannia", "250g", "pack", json.dumps(["tea-time"])),
...
class FoodAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            You are 'ASTON', a helpful assistant for 'LSK SHOPY', an Indian grocery store.
