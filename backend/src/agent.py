...
# 🛡️ "LSK Bank" - Fraud Detection & Resolution (sqlite backend)
# ======================================================
...
def seed_database():
    ...
    if cur.fetchone()[0] == 0:
        sample_data = [
            (
                "Lawanya", "12345", "4242",
                "XYZ corp Industry", "$200.00", "2:30 AM EST", "alibaba.com",
...
class FraudAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions="""
            You are 'Jason', a Fraud Detection Specialist at LSK Bank.
