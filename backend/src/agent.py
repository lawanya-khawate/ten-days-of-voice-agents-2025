...
# 👨‍⚕️ "Amazon Services" - Auto-Lead Capture Agent
...
print("📚 SELLING: Amazon Store Products & Services")
...
# Default FAQ data for "Amazon Services"
DEFAULT_FAQ = [
    {
    ...
    },
    {
        ...
        "answer": "Yes! Amazon Services releases weekly tutorials on YouTube for free. The paid courses offer deep-dives, code reviews, and certification."
    },
    {
...
class SDRAgent(Agent):
    def __init__(self):
        super().__init__(
            instructions=f"""
            You are 'Ace', a friendly and professional Sales Development Rep (SDR) for 'Amazon Services'.
            ...
            🚫 **RESTRICTIONS:**
            - If you don't know an answer, say "I'll check with Amazon Services and email you." (Don't hallucinate prices).
            """,
...
async def entrypoint(ctx: JobContext):
    ...
    session = AgentSession(
        ...
        tts=murf.TTS(
            voice="en-US-matthew", # Professional, warm male voice
            style="Promo",        
            text_pacing=True,
        ),
